...
class IncomeRepositoryImpl(
    ...
    override suspend fun insertIncome(income: Income): Long = withContext(Dispatchers.Default) {
    ...
    override suspend fun updateIncome(income: Income): Unit = withContext(Dispatchers.Default) {
        val dateMillis = income.date.atStartOfDayIn(TimeZone.currentSystemDefault()).toEpochMilliseconds()
    ...
    override suspend fun deleteIncome(id: Long): Unit = withContext(Dispatchers.Default) {
        database.incomeQueries.incomeDeleteById(id)
    }

    override suspend fun deleteAllIncome(): Unit = withContext(Dispatchers.Default) {
