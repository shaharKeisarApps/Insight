...
class ExpenseRepositoryImpl(
    ...
    override suspend fun insertExpense(expense: Expense): Long = withContext(Dispatchers.Default) {
    ...
    override suspend fun updateExpense(expense: Expense): Unit = withContext(Dispatchers.Default) {
        val dateMillis = expense.date.atStartOfDayIn(TimeZone.currentSystemDefault()).toEpochMilliseconds()
    ...
    override suspend fun deleteExpense(id: Long): Unit = withContext(Dispatchers.Default) {
        database.expenseQueries.deleteById(id)
    }

    override suspend fun deleteAllExpenses(): Unit = withContext(Dispatchers.Default) {
