...
import com.keisardev.insight.core.model.DefaultIncomeCategories
...
import com.keisardev.insight.core.database.IncomeCategory as DbIncomeCategory
...
class IncomeCategoryRepositoryImpl(
    ...
    override suspend fun getCategoryById(id: Long): IncomeCategory? = withContext(Dispatchers.Default) {
    ...
    override suspend fun getCategoryCount(): Long = withContext(Dispatchers.Default) {
