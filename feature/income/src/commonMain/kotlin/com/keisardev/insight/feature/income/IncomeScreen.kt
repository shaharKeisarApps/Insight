...
@Parcelize
data object IncomeScreen : Screen, Parcelable {
    data class State(
        ...
        floatingActionButton = {
            AnimatedVisibility(
                ...
                FloatingActionButton(
                    ...
                    Icon(Icons.Default.Add, contentDescription = stringResource(Res.string.income_add_income))
                }
            }
        },
    ) { paddingValues ->
            ...
            state.incomes.isEmpty() -> {
                AnimatedVisibility(
                    ...
                    EmptyState(
                        ...
                        title = stringResource(Res.string.income_empty_title),
                        subtitle = stringResource(Res.string.income_empty_subtitle),
...
private fun IncomeTypeBadge(
    ...
    val (text, containerColor) = when (incomeType) {
        IncomeType.RECURRING -> stringResource(Res.string.income_type_recurring) to MaterialTheme.colorScheme.primaryContainer
        IncomeType.ONE_TIME -> stringResource(Res.string.income_type_one_time) to MaterialTheme.colorScheme.secondaryContainer
    }
    Surface(
